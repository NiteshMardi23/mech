...
document.querySelector(".page2 h1").textContent.split(" ").forEach(function(alpha){
...
document.querySelector(".page4 h1").textContent.split(" ").forEach(function(alpha){
    text += `<span> ${alpha} </span>`

    document.querySelector(".page4 h1").innerHTML=text;    
...
document.querySelector(".page6 h1").textContent.split(" ").forEach(function(alpha){
    text += `<span> ${alpha} </span>`

    document.querySelector(".page6 h1").innerHTML=text;    
...
function canvas2 ()  {      
  ...
  gsap.to(".page7-cir-inr",{
    scrollTrigger:{
      trigger:`.page7-cir-inr`,
      start:`top center`,
      end:`bottom top`,
      scroller:`.main`,
      scrub:.5
...
document.querySelector(".page12-inner h1").textContent.split(" ").forEach(function(alpha){
    text += `<span> ${alpha} </span>`

    document.querySelector(".page12-inner h1").innerHTML=text;    

})

gsap.to(".page12-inner>h1>span",{
  scrollTrigger:{
      trigger:`.page12-inner>h1>span`,
      start:`top bottom`,
      end:`bottom top`,
      scroller:`.main`,
      scrub:.5,
...
document.querySelector(".page12-inner p").textContent.split(" ").forEach(function(alpha){
    text += `<span> ${alpha} </span>`

    document.querySelector(".page12-inner p").innerHTML=text;    

})

gsap.to(".page12-inner>p>span",{
  scrollTrigger:{
      trigger:`.page12-inner>p>span`,
      start:`top bottom`,
      end:`bottom top`,
      scroller:`.main`,
      scrub:.5,
